(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ngx-cookie-service'), require('@angular/core')) :
	typeof define === 'function' && define.amd ? define(['exports', 'ngx-cookie-service', '@angular/core'], factory) :
	(factory((global.ClientStore = {}),global.ngxCookieService,global.core));
}(this, (function (exports,ngxCookieService,core) { 'use strict';
...
var DefaultClientStore = /** @class */ (function () {
    ...
    DefaultClientStore.getDefaultStore = function () {
        ...
        var cs = new CookieStrategy(new ngxCookieService.CookieService(document));
        ...
        selection.forEach(function (s) {
            ...
            switch (s) {
                ...
                case 2 /* Session */:
                    ...
                    break;
                case 0 /* Cookie */:
                    h = new CookieStrategy(new ngxCookieService.CookieService(document));
                    break;
                default:
                    h = new CookieStrategy(new ngxCookieService.CookieService(document));
                    break;
...
exports.DefaultClientStore = DefaultClientStore;
